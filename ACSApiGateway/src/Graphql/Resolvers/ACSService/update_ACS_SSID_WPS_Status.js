...
exports.update_ACS_SSID_WPS_Status = async (error, args, CONTEXT) => {
  try {
      ...
      if (Body.messagecode === 0) {
        ...
        if (AcsUrlDT && AcsUrlDT.URL) {
          let variable = {
            ...
            parameterValues: [
              [
                `InternetGatewayDevice.LANDevice.1.WLANConfiguration.${sExistingPositionSSId}.WPS.Enable`,
                args.bSSIDWPS,
                "xsd:string",
              ],
            ],
